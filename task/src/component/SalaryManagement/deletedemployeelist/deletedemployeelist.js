...
const URL = "http://localhost:3001/employees/deletedemployees"; // Ensure this URL matches your backend route
  ...
  return (
    <div className="deleted-employee-container">
      ...
      <div className="deleted-employee-content">
        <div className="deleted-employee-header">
          <h1>Deleted Employee List</h1>
        </div>

        <div className="deleted-employee-search-filter">
          <input
            type="text"
        ...
        <table className="deleted-employee-table">
          <thead>
            <tr>
              <th>First Name</th>
              <th>Last Name</th>
          ...
          <tbody>
            {filteredDeletedEmployees.length > 0 ? (
              ...
              <tr>
                <td colSpan="11">No deleted employees found</td>
              </tr>
            )}
          </tbody>
        </table>
