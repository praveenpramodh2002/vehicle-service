...
const GeneratePayroll = () => {
    ...
    const fetchBasicSalary = async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:3001/employees/nic/${payrollData.nic}`);
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            try {
                const response = await axios.post('http://localhost:3001/paysheet/generate', payrollData);
    ...
    function downloadPDF(paysheetData) {
        ...
        doc.addImage(logoBase64, 'PNG', 14, 10, 50, 30);
        ...
        doc.text(`Entered By: ..............................`, 10, 250);
        doc.text(`Authorized By: ..............................`, 130, 250);
    ...
    return (
        <div className="container16">
            ...
            <div className="payroll-container16">
