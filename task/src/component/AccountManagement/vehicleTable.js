...
const VehicleTable = ({ vehicles, onEditVehicle, onDeleteVehicle, onRestoreVehicle, onPermanentlyDelete, isDeletedTable }) => {
    ...
    const handlePrint = () => {
        ...
        doc.text('Microservice Center', 14, 40);
          ...
          doc.text('72/A, Makumbura, Pannipitiya', 14, 50);
          doc.text('+94 112203203', 14, 55);
          doc.text('microservicecenter@gmail.com', 14, 60);
